...
tf.flags.DEFINE_integer("evaluate_every", 120, "Evaluate model on dev set after this many steps (default: 100)")
tf.flags.DEFINE_integer("checkpoint_every", 1200, "Save model after this many steps (default: 100)")
...
def train(x_train, y_train, vocabulary, x_dev, y_dev):
    ...
    with tf.Graph().as_default():
        ...
        with sess.as_default():
            ...
            checkpoint_prefix = os.path.join(checkpoint_dir, "model_{}".format(did))
            ...
            path = saver.save(sess, "models/model-final_{}".format(did))
            print("Saved model checkpoint to {}\n".format(path))
