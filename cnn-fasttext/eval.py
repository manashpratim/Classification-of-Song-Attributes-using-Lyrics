...
tf.flags.DEFINE_string("checkpoint_dir", "/home/abhinav/Desktop/MTP/Experiments/genre/deepNN/CNN/random/runs/1528748688/checkpoints", "Checkpoint directory from training run")
...
vocab_path = os.path.join("/home/abhinav/Desktop/cnn-text-classification-tf/runs/1528661550/", "vocab")
vocab_processor = learn.preprocessing.VocabularyProcessor.restore(vocab_path)
x_test = np.array(list(vocab_processor.transform(x_raw)))
'''
x_test,y_test = preprocess_test(did)
#x_tes, y_tes, vocabulary, x_test, y_test = preprocess(did)
...
# Evaluation
# ==================================================
checkpoint_file = "models/model-final_{}".format(did)
#checkpoint_file = "models/model_001-2000"
graph = tf.Graph()
